            ...
            @forelse($announcements as $ann)
                <tr class="hover:bg-slate-50/50 transition">
                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <x-button variant="outline" size="sm" class="px-2.5! py-1! text-xs font-semibold" onclick="window.location.href='{{ route('announcements.show', $ann->id) }}'">
                            Recipients & Read Tracker
                        </x-button>
                    </td>
                </tr>
            @empty
