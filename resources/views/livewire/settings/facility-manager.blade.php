            ...
            <tr class="hover:bg-slate-50/50 transition">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                    <div class="flex items-center gap-2">
                        @if($facility->tenant_id !== null)
                            <x-button variant="outline" size="sm" class="px-2! py-1! text-xs" wire:click="editFacility({{ $facility->id }})">
                                Edit
                            </x-button>
                            <x-button variant="danger" size="sm" class="px-2! py-1! text-xs" wire:click="confirmDelete({{ $facility->id }})">
                                Delete
                            </x-button>
                        @else
