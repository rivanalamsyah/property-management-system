<div class="p-8 bg-white border border-slate-200/80 rounded-3xl shadow-xl space-y-6">
    ...
    @if($successMessage)
        <div class="p-4 bg-emerald-50 border border-emerald-200/60 text-emerald-800 rounded-2xl text-xs leading-relaxed font-medium shadow-2xs flex items-center gap-2">
